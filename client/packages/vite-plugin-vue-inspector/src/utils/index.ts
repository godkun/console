...
export function parseVueRequest(id: string) {
  ...
  if (query.hasOwnProperty('lang.tsx') || query.hasOwnProperty('lang.jsx')) query.isJsx = true
...
export function parseJSXIdentifier(name: JSXIdentifier | JSXMemberExpression) {
  ...
  else return `${parseJSXIdentifier(name.object)}.${parseJSXIdentifier(name.property)}`
}
